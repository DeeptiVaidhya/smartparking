<div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?= base_url() ?>Driver/add_driver" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" name="joning_date" id="datepickers" class="form-control datetimepicker">                                            
                                        </div>
                                    </div>
                                </div>

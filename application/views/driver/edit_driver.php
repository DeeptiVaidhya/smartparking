...
<div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form  action="<?= base_url() ?>Driver/edit_driver" method="post" 
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" name="joning_date" id="datepickers" class="form-control datetimepicker" value="<?= empty($Doctor_data->joning_date) ? "" : $Doctor_data->joning_date  ?>">                                            
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="assign_id" class="form-control" value="<?= empty($Doctor_data->assign_id) ? "" : $Doctor_data->assign_id  ?>">
                                    </div>
                                </div>
                         ...
                         <select class="form-control" id="selectState" name="Country" style="text-transform: capitalize;">
                                  ...
                                  <?php foreach($countries as $country){?>
                                        ...
                                        <option  value="<?php echo $country['name'];?>" <?php if($country['name']==$Doctor_data->Country) echo 'selected="selected" '?>><?php echo $country['name']?></option>
                                        <?php }?>
                                        </select>



                       <!--  <select class="form-control" name="Country" id="txtCountry">
